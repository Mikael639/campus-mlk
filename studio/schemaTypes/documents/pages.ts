...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({name: 'pourquoiText', title: 'Pourquoi — texte', type: 'text', rows: 3}),
    defineField({
      name: 'pourquoiItems',
      title: 'Pourquoi — arguments (4)',
      type: 'array',
      of: [defineArrayMember({type: 'string'})],
    }),
    defineField({name: 'pourquoiWide', title: 'Pourquoi — argument large', type: 'string'}),
